...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXCoreParametersTesting.cs
...
namespace CubeX
{
	namespace Editor
	{
		...
		public static class XCoreParametersTesting
		{
			...
			{
				CParameterObject parameter_inner = new CParameterObject(223, new CParameterString("Имя", "Эра"));

				CParameterObject parameterObject = new CParameterObject("Программа",
					new CParameterString("Имя", "Эра"), parameter_inner);

				Assert.AreEqual(parameterObject.Value[0].Name, "Имя");
				Assert.AreEqual(parameterObject.Value[0].IValue, "Эра");
