...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXUnityEditorInspector.cs
	...
	namespace Core
	{
		...
		public static class XEditorInspector
		{
			...
			public static void PrepareContent(UnityEditor.SerializedProperty property)
			{
				...
				{
					// Есть атрибут имени
					CubeXDisplayNameAttribute name = property.GetAttribute<CubeXDisplayNameAttribute>();
					if (name != null)
					{
			...
			public static void DrawSectionBox(GUIContent content, Color color_text, TextAnchor text_anchor = TextAnchor.MiddleCenter)
			{
				...
				Rect position = UnityEditor.EditorGUILayout.BeginHorizontal();
				{
					...
					GUILayout.Box("", UnityEditor.EditorStyles.helpBox, GUILayout.Height(XEditorInspector.HEADER_HEIGHT + UnityEditor.EditorGUIUtility.standardVerticalSpacing));
				...
				TextAnchor text_anchor = TextAnchor.MiddleCenter)
			{
				...
				// Управляющие кнопки
				Rect rect_button_close = new Rect(mouse_rect.xMax - BUTTON_MINI_WIDTH - 1, mouse_rect.y + 2,
					BUTTON_MINI_WIDTH, XEditorInspector.HEADER_HEIGHT - 1);
				if (GUI.Button(rect_button_close, "X", XEditorStyles.ButtonMiniDefaultRedRightStyle))
				{
					on_delete();
				}

				Rect rect_button_move_down = new Rect(mouse_rect.xMax - BUTTON_MINI_WIDTH*2 - 2, mouse_rect.y + 2,
					BUTTON_MINI_WIDTH, XEditorInspector.HEADER_HEIGHT - 1);
				...
				Rect rect_button_move_up = new Rect(mouse_rect.xMax - BUTTON_MINI_WIDTH * 3 - 3, mouse_rect.y + 2,
					BUTTON_MINI_WIDTH, XEditorInspector.HEADER_HEIGHT - 1);
			...
			public static void DrawGroup(GUIContent content, Color color_text, Int32 indent, TextAnchor text_anchor = TextAnchor.MiddleLeft)
			{
				...
				if (indent > 0)
				{
					...
					GUILayout.Space(OFFSET_INDENT * indent);
					GUILayout.Label(content, style);
			...
			public static void DrawGroupBox(String text, Color color_text, Int32 indent, TextAnchor text_anchor = TextAnchor.MiddleCenter)
			{
				...
				Rect position = UnityEditor.EditorGUILayout.BeginHorizontal();
				{
					...
					GUILayout.Box("", UnityEditor.EditorStyles.helpBox, GUILayout.Height(XEditorInspector.HEADER_HEIGHT));
				...
				TextAnchor text_anchor = TextAnchor.MiddleCenter)
			{
				...
				// Управляющие кнопки
				Rect rect_button_delete = new Rect(mouse_rect.xMax - BUTTON_MINI_WIDTH - 1, mouse_rect.y + 1,
					BUTTON_MINI_WIDTH, XEditorInspector.CONTROL_HEIGHT_SPACE - 1);
				if (GUI.Button(rect_button_delete, "X", XEditorStyles.ButtonMiniDefaultRedRightStyle))
				{
					on_delete();
				}

				Rect rect_button_move_down = new Rect(mouse_rect.xMax - BUTTON_MINI_WIDTH * 2 - 2, mouse_rect.y + 1,
					BUTTON_MINI_WIDTH, XEditorInspector.CONTROL_HEIGHT_SPACE - 1);
				if (GUI.Button(rect_button_move_down, XString.TriangleDown, UnityEditor.EditorStyles.miniButtonMid))
				{
					on_move_down();
				...
				Rect rect_button_move_up = new Rect(mouse_rect.xMax - BUTTON_MINI_WIDTH * 3 - 3, mouse_rect.y + 1,
					BUTTON_MINI_WIDTH, XEditorInspector.CONTROL_HEIGHT_SPACE - 1);
				if (GUI.Button(rect_button_move_up, XString.TriangleUp, UnityEditor.EditorStyles.miniButtonLeft))
				{
					on_move_up();
				...
				TextAnchor text_anchor = TextAnchor.MiddleCenter)
			{
				...
				Rect rect_button_dublicate = new Rect(mouse_rect.xMax - BUTTON_MINI_WIDTH * 2 - 2, mouse_rect.y + 1,
					BUTTON_MINI_WIDTH, XEditorInspector.CONTROL_HEIGHT_SPACE - 1);
				...
				Rect rect_button_move_down = new Rect(mouse_rect.xMax - BUTTON_MINI_WIDTH * 3 - 3, mouse_rect.y + 1,
					BUTTON_MINI_WIDTH, XEditorInspector.CONTROL_HEIGHT_SPACE - 1);
				if (GUI.Button(rect_button_move_down, XString.TriangleDown, UnityEditor.EditorStyles.miniButtonMid))
				{
					on_move_down();
				...
				Rect rect_button_move_up = new Rect(mouse_rect.xMax - BUTTON_MINI_WIDTH * 4 - 4, mouse_rect.y + 1,
					BUTTON_MINI_WIDTH, XEditorInspector.CONTROL_HEIGHT_SPACE - 1);
				if (GUI.Button(rect_button_move_up, XString.TriangleUp, UnityEditor.EditorStyles.miniButtonLeft))
				{
					on_move_up();
				...
				Single offset_right = 0)
			{
				...
				// Рабочая ширина
				Single work_width = context_width - (offset_right + SCROLL_WIDTH);
				rect_label = rect;
				...
				{
					Single delta = rect_field.xMax - work_width - SCROLL_WIDTH;
				...
				out Rect rect_field2, Single coeff3, Single offset_right = 0)
			{
				...
				{
					Single delta = rect_field2.xMax - work_width - SCROLL_WIDTH;
				...
				Single coeff2, out Rect rect_button_right)
			{
				...
				rect_field.width -= BUTTON_MINI_WIDTH;
				rect_button_right = rect;
				rect_button_right.x = rect_field.xMax;
				rect_button_right.width = BUTTON_MINI_WIDTH;
				rect_button_right.height = BUTTON_MINI_HEIGHT;
			}
				...
				Single coeff2, out Rect rect_field2, Single coeff3, out Rect rect_button_right)
			{
				...
				rect_field2.width -= BUTTON_MINI_WIDTH;
				rect_button_right = rect;
			...
			{
				ComputeRects(rect, out rect_label, coeff1, out rect_field, coeff2, 0);
				rect_field.width -= BUTTON_MINI_WIDTH * 2;

				rect_button_left = rect;
				rect_button_left.x = rect_field.xMax;
				rect_button_left.width = BUTTON_MINI_WIDTH;
				rect_button_left.height = BUTTON_MINI_HEIGHT;
			...
			{
				ComputeRects(rect, out rect_label, coeff1, out rect_field, coeff2, 0);
				rect_field.width -= BUTTON_MINI_WIDTH * 3;
				...
				rect_button_middle.width = BUTTON_MINI_WIDTH;
				rect_button_middle.height = BUTTON_MINI_HEIGHT;
			...
			public static Single PropertyFloatManager(String name, Single value, Single min, Single max, Single step)
			{
				...
				UnityEditor.EditorGUILayout.BeginHorizontal();
				{
					...
					if (GUILayout.Button(XString.TriangleDown, UnityEditor.EditorStyles.miniButtonLeft,
						GUILayout.Width(BUTTON_MINI_WIDTH)))
					{
						value -= step;
			...
			public static void DrawDecorateAttributes(CCachedMember cached_data)
			{
				...
				// HeaderSection
				CubeXHeaderSectionAttribute header_section_attribute = cached_data.GetAttribute<CubeXHeaderSectionAttribute>();
				...
				// HeaderSectionBox
				CubeXHeaderSectionBoxAttribute header_section_box_attribute = cached_data.GetAttribute<CubeXHeaderSectionBoxAttribute>();
				...
				// HeaderGroup
				CubeXHeaderGroupAttribute header_group_attribute = cached_data.GetAttribute<CubeXHeaderGroupAttribute>();
				...
				// HeaderGroup
				CubeXHeaderGroupBoxAttribute header_group_box_attribute = cached_data.GetAttribute<CubeXHeaderGroupBoxAttribute>();
