...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXUnityEditorSerializedProperty.cs
...
namespace CubeX
{
	namespace Core
	{
		...
		public static class XExtensionSerializedProperty
		{
			...
			/// <summary>
			/// Имя внутреннего массива для всех типов коллекций системы CubeX
			/// </summary>
			...
			/// </summary>
			/// <remarks>
			/// К коллекциям относятся как стандартные коллекции так и коллекции системы CubeX
			/// </remarks>
			/// <param name="property">Сериализируемое свойство</param>
			...
			//---------------------------------------------------------------------------------------------------------
			/// <summary>
			/// Проверка свойства на тип коллекции CubeX: производные коллекции от <see cref="ListArray{TItem}"/>
			/// </summary>
			/// <param name="property">Сериализируемое свойство</param>
			/// <returns>Статус коллекции свойства</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Boolean IsCubeXCollection(this UnityEditor.SerializedProperty property)
			{
				if (property.propertyType == UnityEditor.SerializedPropertyType.Generic)
				{
					if (property.FindPropertyRelative(NAME_CUBEX_ARRAY) != null)
			...
			//---------------------------------------------------------------------------------------------------------
			/// <summary>
			/// Получение сериализуемого свойства внутреннего массива данных от коллекции CubeX
			/// </summary>
			/// <param name="property">Сериализируемое свойство</param>
			/// <returns>Сериализируемое свойство внутреннего массива данных</returns>
			//---------------------------------------------------------------------------------------------------------
			public static UnityEditor.SerializedProperty GetCubeXInnerCollection(this UnityEditor.SerializedProperty property)
			{
