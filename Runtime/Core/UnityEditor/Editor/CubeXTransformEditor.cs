...
public class CubeXInspectorTransformEditor : Editor
{
	...
	protected void PositionPropertyField()
	{
		EditorGUILayout.BeginVertical();
		{
			EditorGUILayout.BeginHorizontal();
			{
				...
				if (GUILayout.Button(ContentButtonZero, EditorStyles.miniButtonRight, GUILayout.Width(XEditorInspector.BUTTON_MINI_WIDTH)))
				{
					SetPositionZero();
				}
			}
