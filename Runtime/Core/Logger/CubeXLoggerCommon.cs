...
namespace CubeX
{
	...
	{
		//-------------------------------------------------------------------------------------------------------------
		//! \defgroup CoreModuleLogger Подсистема логирования
		...
		//!
		//! ## Описание
		//! Центральный диспетчер подсистемы логирования \ref CubeX.Core.XLogger применяется для трассировки, диагностики, 
		...
		//!
		//! ## Использование
		//! 1. Реализовать интерфейс(логгер) \ref CubeX.Core.ILoggerView для вывода и отображения сообщений
		//! 2. Присоединить объект-логгер к свойству \ref CubeX.Core.XLogger.Logger
		//! \ingroup CoreModule
		/*@{*/
		//-------------------------------------------------------------------------------------------------------------
		/// <summary>
