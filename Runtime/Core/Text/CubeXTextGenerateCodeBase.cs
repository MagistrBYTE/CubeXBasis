...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXTextGenerateCodeBase.cs
...
namespace CubeX
{
	namespace Core
	{
		...
		public abstract class CTextGenerateCodeBase : CTextList
		{
			...
			//---------------------------------------------------------------------------------------------------------
			public CTextGenerateCodeBase(Int32 capacity = 24)
				: base(capacity)
			{
			}
			...
			//---------------------------------------------------------------------------------------------------------
			public CTextGenerateCodeBase(String str)
				: base(str)
			{
			}
			#endregion
			...
			//---------------------------------------------------------------------------------------------------------
			/// <summary>
			/// Добавление стандартного заголовка для файлов кода проекта CubeX
			/// </summary>
