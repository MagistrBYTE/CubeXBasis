...
namespace CubeX
{
	namespace Core
	{
		...
		//-------------------------------------------------------------------------------------------------------------
		/// <summary>
		/// Определение интерфейса для информирования об изменении данных (свойства/поля) через вложенные свойства
		/// </summary>
		/// <remarks>
		/// <para>
		/// Данный интерфейс применятся в родительских отношениях, когда дочерний объект уведомляет родителя об изменении
		...
		/// </remarks>
		//-------------------------------------------------------------------------------------------------------------
		public interface ICubeXNotifyNested
		{
			//---------------------------------------------------------------------------------------------------------
			/// <summary>
			/// Информирование данного объекта о начале изменения данных указанного объекта
			/// </summary>
			/// <param name="source">Объект данные которого будут меняться</param>
			/// <param name="model_name">Имя данных</param>
			/// <param name="data_name">Имя внутренних данных</param>
			/// <returns>Статус разрешения/согласования изменения данных</returns>
			//---------------------------------------------------------------------------------------------------------
			Boolean OnNotifyUpdating(System.Object source, String model_name, String data_name);
			...
			/// <param name="data_name">Имя внутренних данных</param>
			//---------------------------------------------------------------------------------------------------------
			void OnNotifyUpdated(System.Object source, String model_name, String data_name);
		}
		//-------------------------------------------------------------------------------------------------------------
		/*@}*/
		//-------------------------------------------------------------------------------------------------------------
