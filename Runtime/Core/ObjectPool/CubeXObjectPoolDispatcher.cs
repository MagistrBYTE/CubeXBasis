...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXObjectPoolDispatcher.cs
...
namespace CubeX
{
	...
	{
		//-------------------------------------------------------------------------------------------------------------
		//! \addtogroup CoreModuleObjectPool
		/*@{*/
		//-------------------------------------------------------------------------------------------------------------
		/// <summary>
		/// Глобальный диспетчер для управления диспетчерами пулом объектов
		...
		public static class XPoolDispatcher
		{
			...
			/// </summary>
			public readonly static Dictionary<Int32, ICubeXPoolManager> PoolManagers = new Dictionary<Int32, ICubeXPoolManager>();
			#endregion
			...
			//---------------------------------------------------------------------------------------------------------
			public static Boolean RegisterManager(Int32 id, ICubeXPoolManager manager)
			{
