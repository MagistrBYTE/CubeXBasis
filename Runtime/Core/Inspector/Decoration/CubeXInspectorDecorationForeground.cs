...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXInspectorDecorationForeground.cs
...
namespace CubeX
{
	namespace Core
	{
		...
		public sealed class CubeXForegroundAttribute : CubeXInspectorItemAttribute
		{
			#region ======================================= ДАННЫЕ ====================================================
			...
			//---------------------------------------------------------------------------------------------------------
			public CubeXForegroundAttribute(Byte red, Byte green, Byte blue, Byte alpha = 255)
			{
			...
			//---------------------------------------------------------------------------------------------------------
			public CubeXForegroundAttribute(UInt32 color_bgra)
			{
