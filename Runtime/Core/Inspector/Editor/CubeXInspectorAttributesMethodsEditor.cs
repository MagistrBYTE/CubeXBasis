...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXInspectorAttributesMethodsEditor.cs
...
namespace CubeX
{
	namespace Editor
	{
		...
		public class CMethodHolder : IComparable<CMethodHolder>
		{
			...
			/// </summary>
			public CubeXMethodCallAttribute MethodAttribute;
			...
			public virtual void Draw()
			{
				...
				Rect rect_button = EditorGUILayout.BeginHorizontal(GUILayout.Height(XEditorInspector.HEADER_HEIGHT));
				{
		...
		public class CMethodHolderArg1 : CMethodHolder
		{
			...
			protected override void DrawArguments()
			{
				EditorGUILayout.BeginHorizontal();
				{
					...
					CubeXBaseVariantDrawer.DrawLayoutVariant(FirstArgumentName, FirstArgument);
					EditorGUI.indentLevel--;

					if(MethodAttribute is CubeXMethodArgFileAttribute)
					{
						CubeXMethodArgFileAttribute arg_file = MethodAttribute as CubeXMethodArgFileAttribute;
			...
			public override void Draw()
			{
				...
				Rect rect_box = EditorGUILayout.BeginVertical();
				{
					if (Event.current.type != EventType.Layout)
					{
						rect_box.x += XEditorInspector.OFFSET_INDENT;
						rect_box.width -= XEditorInspector.OFFSET_INDENT;
						rect_box.height += 2;
						if (rect_box.height > XEditorInspector.CONTROL_HEIGHT)
						{
		...
		public class CMethodHolderArg2 : CMethodHolderArg1
		{
			...
			protected override void DrawArguments()
			{
				...
				{
					EditorGUI.indentLevel++;
					CubeXBaseVariantDrawer.DrawLayoutVariant(SecondArgumentName, SecondArgument);
					EditorGUI.indentLevel--;
				}
				EditorGUILayout.EndHorizontal();
			}
