...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXInspectorCollectionReorderable.cs
*		Атрибут для расширенного отображения и управления элементами стандартных коллекций и коллекциями CubeX.
*/
//---------------------------------------------------------------------------------------------------------------------
// Версия: 1.0.0.0
...
namespace CubeX
{
	...
	{
		//-------------------------------------------------------------------------------------------------------------
		//! \defgroup CoreModuleInspectorCollection Атрибуты для отображения коллекций
		...
		public sealed class CubeXReorderableAttribute : Attribute
		{
			#region ======================================= ДАННЫЕ ====================================================
			...
			/// </summary>
			//---------------------------------------------------------------------------------------------------------
			public CubeXReorderableAttribute()
			{
			}
			#endregion
		}
