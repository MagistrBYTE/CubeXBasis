...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXInspectorCollectionInLine.cs
...
namespace CubeX
{
	namespace Core
	{
		...
		/// <remarks>
		/// <para>
		/// Функциональность атрибута реализуется атрибутом <see cref="CubeXReorderableAttribute"/>
		/// </para>
		/// <para>
		/// Должен применяться для сложных типов, при этом дочерние поля/свойства должны иметь атрибут <see cref="CubeXColumnAttribute"/>
		/// </para>
		/// </remarks>
		//-------------------------------------------------------------------------------------------------------------
		[AttributeUsage(AttributeTargets.Property | AttributeTargets.Field, Inherited = false, AllowMultiple = false)]
		public class CubeXInLineAttribute : Attribute
		{
			#region ======================================= ДАННЫЕ ====================================================
			#endregion
			...
			public UnityEngine.Rect[] GetRectsFromPercent(Int32 count, params Single[] percents)
			{
				...
				if (count > 0)
				{
					...
					rects[0].height = XEditorInspector.CONTROL_HEIGHT;
