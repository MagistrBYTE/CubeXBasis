...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXInspectorMethodCall.cs
...
namespace CubeX
{
	...
	{
		//-------------------------------------------------------------------------------------------------------------
		//! \defgroup CoreModuleInspectorMethods Атрибуты вызова метода
		...
		public class CubeXMethodCallAttribute : Attribute
		{
			#region ======================================= ДАННЫЕ ====================================================
			...
			/// </summary>
			//---------------------------------------------------------------------------------------------------------
			public CubeXMethodCallAttribute()
			{
			...
			//---------------------------------------------------------------------------------------------------------
			public CubeXMethodCallAttribute(String human_name, TMethodCallMode button_mode = TMethodCallMode.Always)
			{
			...
			/// <param name="button_mode">Режим вызова метода</param>
			//---------------------------------------------------------------------------------------------------------
			public CubeXMethodCallAttribute(String human_name, Int32 draw_order, TMethodCallMode button_mode = TMethodCallMode.Always)
			{
				mDisplayName = human_name;
