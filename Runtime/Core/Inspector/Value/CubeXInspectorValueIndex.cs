...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXInspectorValueIndex.cs
...
namespace CubeX
{
	namespace Core
	{
		...
		public sealed class CubeXIndexToStringAttribute : Attribute
		{
			#region ======================================= ДАННЫЕ ====================================================
			...
			//---------------------------------------------------------------------------------------------------------
			public CubeXIndexToStringAttribute(String member_name, TInspectorMemberType member_type)
			{
			...
			/// <param name="member_type">Тип члена объекта</param>
			//---------------------------------------------------------------------------------------------------------
			public CubeXIndexToStringAttribute(Type type, String member_name, TInspectorMemberType member_type)
			{
				mSourceType = type;
				mMemberName = member_name;
				mMemberType = member_type;
