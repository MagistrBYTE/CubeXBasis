...
namespace CubeX
{
	...
	{
		//-------------------------------------------------------------------------------------------------------------
		//! \defgroup CoreModuleMessage Подсистема сообщений
		...
		//! 5. Полностью интегрирована в систему CubeX в качестве основной
		//!
		//! ## Описание
		//! Подсистема сообщений очень простая. Отправка сообщений происходит через статический метод центрального диспетчера
		//! сообщений \ref CubeX.Core.XMessageDispatcher. Для обработки сообщения нужно реализовать соответствующий интерфейс 
		//! \ref CubeX.Core.ICubeXMessageHandler. 
		...
		//!
		//! ## Использование
		//! 1. Реализовать интерфейс \ref CubeX.Core.ICubeXMessageHandler
		//! 2. Зарегистрировать компонент в диспетчере \ref CubeX.Core.XMessageDispatcher
		//! 3. Теперь можно посылать команды через диспетчер \ref CubeX.Core.XMessageDispatcher
		...
		/// </remarks>
		//-------------------------------------------------------------------------------------------------------------
		public class CMessageArgs : CVariant, ICubeXPoolObject
		{
			#region ======================================= ДАННЫЕ ====================================================
			// Основные параметры
			internal Int32 mID;
		...
		/// </summary>
		//-------------------------------------------------------------------------------------------------------------
		public interface ICubeXMessageHandler
		{
			#region ======================================= СВОЙСТВА ==================================================
			/// <summary>
