...
namespace CubeX
{
	...
	{
		//-------------------------------------------------------------------------------------------------------------
		//! \defgroup UnityCommonResource Подсистема ресурсов
		...
		public class CResourceId : IComparable<CResourceId>
		{
			...
			[CubeXSerializeMember(nameof(Path))]
			internal String mPath;
			[CubeXSerializeMember(nameof(Index))]
			internal Int32 mIndex;
			[CubeXSerializeMember(nameof(ID))]
			internal Int32 mID;
			[CubeXSerializeMember(nameof(Creation))]
