...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXGenerateCodeWindow.cs
...
/// </summary>
//---------------------------------------------------------------------------------------------------------------------
public class CubeXGenerateCodeWindow : CubeXUtilityBaseWindow
{
	...
	/// </summary>
	//-----------------------------------------------------------------------------------------------------------------
	[MenuItem(XCommonEditorSettings.MenuPathUtility + "Generate Code", false, XCommonEditorSettings.MenuOrderUtility + 20)]
	public static void ShowGenerateCode()
	{
		var window = GetWindow<CubeXGenerateCodeWindow>();
	...
	public void DrawAutogenTags()
	{
		...
		GUILayout.Space(4.0f);
		EditorGUILayout.LabelField("Файл: CubeXBaseUnityTags", EditorStyles.boldLabel);
		...
		if (GUILayout.Button("Generate"))
		{
			...
			generateCode.AddFileBriefDesc("CubeXBaseUnityTags.cs", "Общие данные для организации работы с тэгами объектов Unity");
			generateCode.AddFileVersion();
			generateCode.AddNamespaceUsing("System", "UnityEngine");
			generateCode.AddNamespaceOpen("CubeX");
			{
			...
			generateCode.Save(@"CubeX\Source\Common\Base\CubeXBaseUnityTags.cs");
		}
	}
	#endregion
	...
	public void DrawAutogenLayers()
	{
		...
		GUILayout.Space(4.0f);
		EditorGUILayout.LabelField("Файл: CubeXBaseUnityLayers", EditorStyles.boldLabel);
		...
		if (GUILayout.Button("Generate"))
		{
			CTextGenerateCodeCSharp generateCode = new CTextGenerateCodeCSharp();
			generateCode.AddFileHeader("Модуль общей функциональности", "Базовая подсистема Unity");
			generateCode.AddFileBriefDesc("CubeXBaseUnityLayers.cs", "Общие данные для организации работы с различными слоями в Unity");
			generateCode.AddFileVersion();
			generateCode.AddNamespaceUsing("System", "UnityEngine");
			generateCode.AddNamespaceOpen("CubeX");
			{
			...
			generateCode.SetLengthWithTabsOnlyDelimetrs(120);
			generateCode.Save(@"CubeX\Source\Common\Base\CubeXBaseUnityLayers.cs");
		}
	}
	...
	public void DrawAutogenAxis()
	{
		...
		GUILayout.Space(4.0f);
		EditorGUILayout.LabelField("Файл: CubeXBaseUnityAxes", EditorStyles.boldLabel);
		...
		if (GUILayout.Button("Generate"))
		{
			CTextGenerateCodeCSharp generateCode = new CTextGenerateCodeCSharp();
			generateCode.AddFileHeader("Модуль общей функциональности", "Базовая подсистема Unity");
			generateCode.AddFileBriefDesc("CubeXBaseUnityAxes.cs", "Общие данные для организации работы с осями ввода Unity");
			generateCode.AddFileVersion();
			generateCode.AddNamespaceUsing("System", "UnityEngine");
			generateCode.AddNamespaceOpen("CubeX");
			{
			...
			generateCode.SetLengthWithTabsOnlyDelimetrs(120);
			generateCode.Save(@"CubeX\Source\Common\Base\CubeXBaseUnityAxes.cs");
		}
	}
