...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXSystemManagerWindow.cs
*		Редактор для управления основными системными параметрами и настройки системы CubeX.
*/
//---------------------------------------------------------------------------------------------------------------------
// Версия: 1.0.0.0
...
/// </summary>
//---------------------------------------------------------------------------------------------------------------------
public class CubeXSystemManagerWindow : CubeXUtilityBaseWindow
{
	#region =============================================== СТАТИЧЕСКИЕ МЕТОДЫ ========================================
	//-----------------------------------------------------------------------------------------------------------------
	/// <summary>
	/// Показать окно редактора для управления основными системными параметрами и настройки системы CubeX
	/// </summary>
	//-----------------------------------------------------------------------------------------------------------------
	[MenuItem(XCommonEditorSettings.MenuPathUtility + "System Parameters", false, XCommonEditorSettings.MenuOrderUtility + 5)]
	public static void ShowSystemManager()
	{
		var window = GetWindow<CubeXSystemManagerWindow>();
	...
	/// </summary>
	//-----------------------------------------------------------------------------------------------------------------
	[MenuItem(XCommonEditorSettings.MenuPath + "Remove Missing GameObject", false, XCommonEditorSettings.MenuOrderUtility + 1000)]
	...
	/// </summary>
	//-----------------------------------------------------------------------------------------------------------------
	[MenuItem(XCommonEditorSettings.MenuPath + "Remove Missing All", false, XCommonEditorSettings.MenuOrderUtility + 1001)]
	...
	public void SetExecutionOrder()
	{
		...
		foreach (MonoScript mono_script in MonoImporter.GetAllRuntimeMonoScripts())
		{
			...
			if (type != null)
			{
				CubeXExecutionOrderAttribute attribute = type.GetAttribute<CubeXExecutionOrderAttribute>();
				if (attribute != null)
				{
	...
	public void DrawExecutionOrder()
	{
		...
		mExecutionOrderInfo = "Скрипты системы CubeX исполняются в порядке от: " + mExecutionOrderStart.ToString() +
	...
	{
		GUILayout.Space(4);
		GUILayout.Label("Все настройки СubeX расположены в файле CubeXUnityEditorSettings", EditorStyles.boldLabel);
	}
	...
	public void DrawExport()
	{
		...
		String path_example_basis = "Assets/CubeXExample/Basis/";

		String core_source = XCoreEditorSettings.SourcePath.RemoveLastOccurrence("/");
		String core_name = "CubeX.Core";
		...
		String algo_name = "CubeX.Algorithm";
		...
		String common_name = "CubeX.Common";
