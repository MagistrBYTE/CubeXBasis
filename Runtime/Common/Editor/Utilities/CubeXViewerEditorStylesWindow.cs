...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXViewerEditorStylesWindow.cs
...
/// </remarks>
//---------------------------------------------------------------------------------------------------------------------
public class CubeXViewerEditorStylesWindow : EditorWindow
{
	...
	/// </summary>
	//-----------------------------------------------------------------------------------------------------------------
	[MenuItem(XCommonEditorSettings.MenuPathUtility + "Viewer Editor Styles", false, XCommonEditorSettings.MenuOrderUtility + 20)]
	public static void ShowViewerEditorStyles()
	{
		var window = GetWindow<CubeXViewerEditorStylesWindow>();
