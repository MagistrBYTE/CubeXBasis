...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXLocalizationDispatcherEditor.cs
...
/// </summary>
//---------------------------------------------------------------------------------------------------------------------
[CustomEditor(typeof(CubeXLocalizationDispatcher))]
public class CubeXLocalizationDispatcherEditor : Editor
{
	...
	/// </summary>
	//-----------------------------------------------------------------------------------------------------------------
	[MenuItem(XCommonEditorSettings.MenuPathLocalization + "Create Localization Dispatcher", false, XCommonEditorSettings.MenuOrderLocalization)]
	public static void Create()
	{
#pragma warning disable 0219
		CubeXLocalizationDispatcher localization_service = CubeXLocalizationDispatcher.Instance;
#pragma warning restore 0219
	}
	#endregion

	#region =============================================== ДАННЫЕ ====================================================
	private CubeXLocalizationDispatcher mDispatcher;
	...
	{
		mDispatcher = this.target as CubeXLocalizationDispatcher;
	...
	public void DrawLanguages()
	{
		...
		if (mDispatcher.mExpandedLanguages)
		{
			...
			GUILayout.Space(2.0f);
			if (GUILayout.Button(mContentAdd, XEditorStyles.ButtonMiniHeaderMiddleStyle, GUILayout.Width(XEditorInspector.BUTTON_MINI_WIDTH)))
			{
