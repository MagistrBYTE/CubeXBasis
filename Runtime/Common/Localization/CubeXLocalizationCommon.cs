...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXLocalizationCommon.cs
...
namespace CubeX
{
	...
	{
		//-------------------------------------------------------------------------------------------------------------
		//! \defgroup UnityCommonLocalization Подсистема локализации
		...
		//! В в центральном диспетчере локализации \ref CubeX.Common.CubeXLocalizationDispatcher происходит загрузка в 
		//! словарь (если поддерживается ключ локализации) или в список.
		//!
		//! ## Использование
		//! 1. Работа ведется в режиме редактора с помощью диспетчера локализации \ref CubeX.Common.CubeXLocalizationDispatcher.
		...
		/// </remarks>
		//-------------------------------------------------------------------------------------------------------------
		public interface ICubeXLocalizableBase
		{
			#region ======================================= МЕТОДЫ ====================================================
			//---------------------------------------------------------------------------------------------------------
			/// <summary>
		...
		/// </remarks>
		//-------------------------------------------------------------------------------------------------------------
		public interface ICubeXLocalizable : ICubeXLocalizableBase
		{
			#region ======================================= СВОЙСТВА ==================================================
			/// <summary>
			/// Текст
		...
		public struct TLocalizableText : IEquatable<TLocalizableText>, IComparable<TLocalizableText>, ICloneable
		{
			...
			public void SetLocalizableData()
			{
				...
				{
					CubeXLocalizationDispatcher.GetTextCurrentFromID(IDKeyLocalize, out Text);
				}
				else
				{
					if(IDKeyLocalize == 0)
					{
						Text = CubeXLocalizationDispatcher.GetTextCurrentFromTextDefault(Text);
					}
				}
			}
			#endregion
