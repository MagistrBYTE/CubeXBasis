...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXTweenSpriteImage.cs
*		Компонент для хранения и управления анимацией спрайтов для стандартного компонента изображения.
*		Реализация компонента для хранения (используется хранилища анимационных спрайтов) и управления анимацией 
*	спрайтов для стандартного компонента изображения.
*/
//---------------------------------------------------------------------------------------------------------------------
// Версия: 1.0.0.0
...
namespace CubeX
{
	namespace Common
	{
		...
		/// </summary>
		/// <remarks>
		/// Реализация компонента для хранения (используется хранилища анимационных спрайтов) и управления
		/// анимацией спрайтов для стандартного компонента изображения.
		/// </remarks>
		//-------------------------------------------------------------------------------------------------------------
		[Serializable]
		[AddComponentMenu("CubeX/Common/Tween/Animation Sprite")]
		public class CubeXTweenSpriteImage : MonoBehaviour
		{
			#region ======================================= ДАННЫЕ ====================================================
			[SerializeField]
			...
			[SerializeField]
			[CubeXDisplayName(nameof(IsUpdate))]
			[CubeXSerializeMember(nameof(IsUpdate))]
			...
			public Sprite FrameSprite
			{
				get
				{
					...
					{
						return CubeXTweenDispatcher.SpriteStorage.GetFrameSprite(mTweenSprite.GroupIndex, mTweenSprite.GroupSpriteIndex, mTweenSprite.FrameIndex);
					}
				}
			}
			...
			public CTweenSpriteData this[Int32 index]
			{
				get
				{
					return CubeXTweenDispatcher.SpriteStorage[mTweenSprite.GroupIndex, index];
				}
			}
			#endregion
			...
			public void UpdateAnimation()
			{
				...
				mUIImage.sprite = CubeXTweenDispatcher.SpriteStorage.GetFrameSprite(mTweenSprite.GroupIndex,
