...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXSerializationComponent.cs
...
namespace CubeX
{
	namespace Common
	{
		...
		//-------------------------------------------------------------------------------------------------------------
		[Serializable]
		[CubeXSerializeDisableAttribute]
		[AddComponentMenu("CubeX/Common/Serialization/Serialization Component")]
		public class CubeXSerializationComponent : MonoBehaviour, IComparable<CubeXSerializationComponent>
		{
			#region ======================================= ДАННЫЕ ====================================================
			...
			//---------------------------------------------------------------------------------------------------------
			public Int32 CompareTo(CubeXSerializationComponent other)
			{
			...
			{
				return (GetInstanceID() << 32) + (transform.GetHashCode() ^ name.GetHashCode());
			}
			#endregion
		}
		//-------------------------------------------------------------------------------------------------------------
