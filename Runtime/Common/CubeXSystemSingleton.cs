...
namespace CubeX
{
	...
	{
		//-------------------------------------------------------------------------------------------------------------
		//! \defgroup UnityCommon МОДУЛЬ ОБЩЕЙ ФУНКЦИОНАЛЬНОСТИ
		...
		/// </summary>
		//-------------------------------------------------------------------------------------------------------------
		public interface ICubeXSingleton
		{
			/// <summary>
		...
		//-------------------------------------------------------------------------------------------------------------
		[Serializable]
		public class CubeXSystemSingleton<TMonoBehaviour> : MonoBehaviour where TMonoBehaviour : MonoBehaviour, ICubeXSingleton
		{
			...
			protected static void CreateInstance()
			{
				...
				if (mInstance == null)
				{
					...
					GameObject go = new GameObject(type_singleton.Name.Replace("CubeX", ""), type_singleton);
			...
			/// свойство которого <see cref="CubeXSystemSingleton.IsMainInstance"/> равно True
			/// </remarks>
