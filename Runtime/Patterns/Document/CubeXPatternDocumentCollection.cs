...
*		Шаблон документа для коллекций.
*/
//---------------------------------------------------------------------------------------------------------------------
// Версия: 1.0.0.0
...
namespace CubeX
{
	namespace Core
	{
		...
		//-------------------------------------------------------------------------------------------------------------
		public class DocumentCollection<TModel> : CollectionModel<TModel>, ICubeXDocument, ICubeXUIModelSupportExplore, ICubeXUIModelContextMenu
