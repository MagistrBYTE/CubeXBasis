...
//---------------------------------------------------------------------------------------------------------------------
/** \file CubeXAlgorithmPathFinderCommon.cs
...
namespace CubeX
{
	...
	{
		//-------------------------------------------------------------------------------------------------------------
		//! \defgroup AlgorithmModulePathFinder Алгоритмы поиска пути
		...
		/// </summary>
		//-------------------------------------------------------------------------------------------------------------
		public interface ICubeXPathFinder
		{
			#region ======================================= СВОЙСТВА ==================================================
			//
			// ОСНОВНЫЕ ПАРАМЕТРЫ
		...
		/// </summary>
		//-------------------------------------------------------------------------------------------------------------
		public abstract class CPathFinder : ICubeXPathFinder
		{
			#region ======================================= ДАННЫЕ ====================================================
			// Основные параметры
			protected internal ICubeXMap2D mMap;
			...
			#region ======================================= СВОЙСТВА ICubeXPathFinder =================================
			//
			// ОСНОВНЫЕ ПАРАМЕТРЫ
			//
			/// <summary>
			...
			//---------------------------------------------------------------------------------------------------------
			protected CPathFinder(ICubeXMap2D map)
			{
				mMap = map;
				mPath = new CPath();
			}
			...
			#region ======================================= МЕТОДЫ ICubeXPathFinder ===================================
			//---------------------------------------------------------------------------------------------------------
			/// <summary>
			/// Поиск пути по предварительно установленным параметрам
			/// </summary>
